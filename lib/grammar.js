...
bnf = {
  ...
  Expression: [
    o('Chain CLONEPORT Expression', function(){
      ...
      return Unary($1, $2);
    }), o('YIELD Expression', ditto), o('+-    Expression', ditto, {
      prec: 'UNARY'
    ...
    }), o('LoopHead Block Nobreak', function(){
      return $1.addBody($2).addNobreak($3);
  ...
  Nobreak: [o('NOBREAK Block', function(){
    return $2;
  })],
  LoopHead: [
